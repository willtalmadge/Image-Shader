...
#ifndef __Image_Shader__FFTInterleaveToFtNdc__
#define __Image_Shader__FFTInterleaveToFtNdc__
...
struct FFTInterleaveToFtNdc : public ISDrawable<ISComplex, ISSingleton, FFTInterleaveToFtNdc>, ISComplexBindable
{
    using ISDrawableT = ISDrawable<ISComplex, ISSingleton, FFTInterleaveToFtNdc>;
    ...
    FFTInterleaveToFtNdc(GLuint width, GLuint height, OutType outType) : ISDrawableT(width, height), _outType(outType), _orthoMatrixPosition(0) {
    ...
    bool compareImpl(const FFTInterleaveToFtNdc& rhs) const {
        bool result = true;
...
#endif /* defined(__Image_Shader__FFTInterleaveToFtNdc__) */
